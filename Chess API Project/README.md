...
Currently, I am working on a program to analyze the moves that were played in each game, as well as the games of players at a similar skill level. My goal is to assess whether certain opening moves lead to higher chances of winning, as well as the likelihood of making a "blunder" under certain conditions.
